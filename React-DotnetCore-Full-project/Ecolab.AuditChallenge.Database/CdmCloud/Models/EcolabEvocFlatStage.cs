...
{
    public partial class EcolabEvocFlatStage
    {
        ...
        public string HierarchyReferenceNodeStatus { get; set; } = null!;
        public int SlsacctContextPointKey { get; set; }
        public string SlsacctContextPointName { get; set; } = null!;
        public string SlsacctContextPointDescription { get; set; } = null!;
        public string SlsacctContextPointEdgeStatus { get; set; } = null!;
        public int? SldtoAcctContextPointKey { get; set; }
        public string? SldtoAcctContextPointName { get; set; }
        public string? SldacctContextPointDescription { get; set; }
        public string? SldtoAcctContextPointEdgeStatus { get; set; }
        ...
        public int EcolabEvocFlatId { get; set; }
    }
}
