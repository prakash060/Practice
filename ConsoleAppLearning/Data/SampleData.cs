...
namespace ConsoleAppLearning.Data
{
    public static class SampleData
    {
        public static List<Employee> GetEmployees()
        {
            var employees = new List<Employee>
            {
                ...
                new Employee{Id=3, Name="Manu",City="Naganur", DepartmentId = 1},
                new Employee{Id=4, Name="Clerk",City="Gokak", DepartmentId = 6},
                new Employee{Id=5, Name="John",City="Naganur", DepartmentId = 4},
                new Employee{Id=6, Name="Manu",City="Naganur", DepartmentId = 3},
                new Employee{Id=7, Name="Yash",City="Belgaum", DepartmentId = 3},
                new Employee{Id=8, Name="Shweta",City="Naganur", DepartmentId = 4},
                new Employee{Id=9, Name="John",City="Naganur", DepartmentId = 4}
            };
